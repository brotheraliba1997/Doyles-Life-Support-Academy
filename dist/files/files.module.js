...
const files_module_1 = require("./uploader/local/files.module");
const files_module_2 = require("./uploader/s3/files.module");
const files_module_3 = require("./uploader/s3-presigned/files.module");
...
exports.FilesModule = FilesModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [files_service_1.FilesService, mongoose_1.MongooseModule],
    })
], FilesModule);
