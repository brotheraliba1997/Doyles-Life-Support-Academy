...
const courses_service_1 = require("../../course/courses.service");
...
async function seedCoursesFromPricingPage() {
    ...
    try {
        ...
        const professionalDevCategory = await categoriesService.findBySlug('professional-development');
        const businessTrainingCategory = await categoriesService.findBySlug('business-training');
        if (!professionalDevCategory || !businessTrainingCategory) {
            throw new Error('Categories not found! Please ensure categories are created first.');
        }
        ...
        const instructorId = '6903c027053f3ed74ac25eb9';
        const courses = [
            {
                ...
                description: 'Get started with professional development. Access essential training materials, live sessions, and core learning resources.',
                ...
                overview: 'Monthly subscription providing access to core professional development content. Perfect for individuals starting their career development journey.',
                thumbnailUrl: 'https://images.unsplash.com/photo-1552664730-d307ca884978',
                sessions: [
                    {
                        type: course_schema_1.SessionFormatEnum.FULL_WEEK,
                        timeBlocks: [
                            {
                    ...
                    {
                        type: course_schema_1.SessionFormatEnum.WEEKEND,
                        timeBlocks: [
                            {
                ...
                snapshot: {
                    totalLectures: 30,
                    totalDuration: 15,
                    skillLevel: course_schema_1.SkillLevelEnum.BEGINNER,
                    language: 'English',
                    enrolledStudents: 0,
                    certificate: true,
                ...
                faqs: [
                    {
                        ...
                        answer: 'Yes, you can cancel your subscription at any time. You will have access until the end of your billing period.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        answer: 'We add new content monthly and update existing materials regularly.',
                    },
                ],
                price: 77.0,
                currency: course_schema_1.CurrencyEnum.USD,
                isPublished: true,
                isFeatured: false,
                isBestseller: false,
                isNew: true,
            },
            {
                ...
                description: 'Complete professional development program with lifetime access. Includes all core training modules, live sessions, and certification.',
                category: 'professional-development',
                ...
                overview: 'One-time investment for lifetime access to comprehensive corporate training. Perfect for professionals committed to long-term career development.',
                ...
                sessions: [
                    ...
                    {
                        type: course_schema_1.SessionFormatEnum.EVENING,
                        timeBlocks: [
                            {
                ...
                snapshot: {
                    totalLectures: 75,
                    totalDuration: 35,
                    skillLevel: course_schema_1.SkillLevelEnum.INTERMEDIATE,
                    language: 'English',
                ...
                faqs: [
                    {
                        ...
                        answer: 'Yes! One-time payment gives you lifetime access to all course materials, including future updates.',
                    },
                    {
                        question: 'Is there a certification?',
                        answer: 'Yes, you will receive a professional certificate upon successful completion of the program.',
                    },
                    {
                        question: 'What if I need help during the course?',
                        answer: 'You can ask questions in our community forum and join quarterly live Q&A sessions with instructors.',
                    },
                    {
                        question: 'Can I access on mobile devices?',
                        answer: 'Yes, all content is mobile-friendly and accessible on any device.',
                    },
                ],
                price: 333.0,
                currency: course_schema_1.CurrencyEnum.USD,
            ...
            },
            {
                ...
                description: 'Premium tier with exclusive content, personalized coaching, and advanced training materials. Designed for executives and senior professionals.',
                ...
                overview: 'Premium monthly subscription with exclusive executive-level content, 1-on-1 coaching sessions, and advanced strategic training.',
                thumbnailUrl: 'https://images.unsplash.com/photo-1521737711867-e3b97375f902',
                sessions: [
                    {
                        type: course_schema_1.SessionFormatEnum.SPLIT_WEEK,
                        timeBlocks: [
                            {
                ...
                snapshot: {
                    totalLectures: 120,
                    totalDuration: 60,
                    skillLevel: course_schema_1.SkillLevelEnum.ADVANCED,
                    language: 'English',
                ...
                faqs: [
                    {
                        ...
                        answer: 'Premium includes monthly 1-on-1 coaching, exclusive executive content, weekly live masterclasses, and priority access to all new features and content.',
                    },
                    {
                        question: 'Who are the coaches?',
                        answer: 'Our coaches are experienced C-level executives and senior business leaders with 20+ years of experience in Fortune 500 companies.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        answer: 'No minimum commitment. You can cancel anytime, though we recommend at least 3 months to see meaningful results.',
                    },
                    {
                        question: 'Do you offer group/corporate rates?',
                        answer: 'Yes! Contact our corporate team for special pricing for teams of 5 or more.',
                    },
                ],
                price: 147.0,
                currency: course_schema_1.CurrencyEnum.USD,
            ...
            },
            {
                ...
                description: 'Ultimate professional development package. Lifetime access to all premium content, unlimited coaching credits, and exclusive executive resources.',
                category: 'business-training',
                subcategories: ['Strategy', 'Operations', 'Finance', 'Marketing'],
                topics: [
                    'Executive Leadership',
                ...
                overview: 'The complete executive development solution. One-time investment for lifetime premium access to all content, quarterly 1-on-1 coaching, and exclusive executive network.',
                ...
                snapshot: {
                    totalLectures: 250,
                    totalDuration: 120,
                    skillLevel: course_schema_1.SkillLevelEnum.ALL_LEVELS,
                    language: 'English',
                ...
                faqs: [
                    {
                        ...
                        answer: 'Yes! One payment, lifetime access. You will never be charged again and will receive all future updates and new content free forever.',
                    },
                    {
                        question: 'What about the coaching sessions?',
                        answer: 'You get 4 executive coaching sessions per year (one per quarter) for life. Each session is 60 minutes with a senior executive coach.',
                    },
                    {
                        question: 'Can I use this for my entire team?',
                        answer: 'This is an individual license. For team licensing, please contact our corporate sales team for custom pricing.',
                    },
                    {
                        question: 'What if I am not satisfied?',
                        answer: 'We offer a 30-day money-back guarantee. If you are not completely satisfied, we will refund your full payment.',
                    },
                    {
                        question: 'How is this different from the $333 Standard plan?',
                        answer: 'In addition to lifetime access to more content (250 vs 75 lessons), you get quarterly coaching sessions, access to executive retreats, mastermind groups, and VIP network - valued at over $5,000/year.',
                    },
                    {
                        question: 'Can I pay in installments?',
                        answer: 'Yes! We offer payment plans. Contact our support team for installment options.',
                    },
                ],
                price: 997.0,
                currency: course_schema_1.CurrencyEnum.USD,
...
//# sourceMappingURL=seed-pricing-page-courses.js.map