...
async function seedCourses() {
    ...
    try {
        let professionalDevCategory;
        let businessTrainingCategory;
        try {
            professionalDevCategory = await categoriesService.findBySlug('professional-development');
        }
        catch (error) {
        ...
        const professionalDevCategoryId = (0, convert_id_1.convertIdToString)(professionalDevCategory);
        const businessTrainingCategoryId = (0, convert_id_1.convertIdToString)(businessTrainingCategory);
        if (!professionalDevCategoryId || !businessTrainingCategoryId) {
            ...
            throw new Error('Failed to get category IDs. Please check category creation.');
        }
        ...
        const instructorId = '690ca50a894467cca53ecb92';
        const locationId = '6931b6698080a892831ad377';
        const courses = [
            {
                title: 'Advanced Leadership Mastery',
                slug: 'advanced-leadership-mastery',
                subtitle: 'Transform into an Exceptional Leader',
                description: 'Master advanced leadership techniques and strategies to lead high-performing teams and drive organizational success.',
                ...
                overview: 'Comprehensive leadership program designed for senior managers and executives looking to enhance their leadership capabilities.',
            ...
            },
            {
                ...
                description: 'Comprehensive project management training covering PMP exam preparation and real-world project execution.',
                category: professionalDevCategoryId,
            ...
            },
            {
                ...
                description: 'Learn to analyze financial statements, create reports, and make data-driven financial decisions.',
                category: businessTrainingCategoryId,
            ...
            },
            {
                ...
                description: 'Enhance your communication skills for better workplace relationships and career success.',
                category: professionalDevCategoryId,
            ...
            },
            {
                ...
                description: 'Learn to create comprehensive business plans and strategic roadmaps for organizational success.',
                category: businessTrainingCategoryId,
                subcategories: ['Strategy'],
                topics: [
                    'Business Planning',
            ...
            },
            {
                ...
                description: 'Learn to provide exceptional customer service and build lasting customer relationships.',
                category: businessTrainingCategoryId,
            ...
            },
            {
                ...
                description: 'Master supply chain management principles, logistics, and optimization strategies.',
                category: businessTrainingCategoryId,
                subcategories: ['Operations'],
                topics: [
                    'Logistics',
            ...
            },
            {
                ...
                description: 'Learn proven time management techniques to increase productivity and achieve work-life balance.',
                category: professionalDevCategoryId,
                subcategories: ['Corporate Training'],
                topics: [
                    'Productivity',
            ...
            },
            {
                ...
                description: 'Learn advanced sales techniques, negotiation skills, and business development strategies.',
                category: businessTrainingCategoryId,
                subcategories: ['Marketing'],
                topics: [
                    'Sales Techniques',
            ...
            },
            {
                ...
                description: 'Master HR management including recruitment, employee relations, performance management, and compliance.',
                category: professionalDevCategoryId,
                subcategories: ['Management'],
                topics: [
                    'Recruitment',
            ...
            },
            {
                ...
                description: 'Learn to analyze business data, create dashboards, and make data-driven business decisions.',
                category: businessTrainingCategoryId,
                subcategories: ['Strategy'],
                topics: [
                    'Data Analysis',
            ...
            },
            {
                ...
                description: 'Learn effective conflict resolution and mediation techniques for the workplace.',
                category: professionalDevCategoryId,
                subcategories: ['Corporate Training'],
                topics: [
                    'Conflict Management',
            ...
            },
            {
                ...
                description: 'Learn to optimize business operations, improve efficiency, and reduce costs.',
                category: businessTrainingCategoryId,
                subcategories: ['Operations'],
                topics: [
            ...
            },
            {
                ...
                description: 'Learn to build, motivate, and manage high-performing teams for organizational success.',
                category: professionalDevCategoryId,
            ...
            },
            {
                ...
                description: 'Learn the fundamentals of entrepreneurship including business planning, funding, and growth strategies.',
                category: businessTrainingCategoryId,
                subcategories: ['Strategy'],
                topics: [
                    'Business Planning',
            ...
            },
            {
                ...
                description: 'Learn to effectively lead and manage organizational change initiatives.',
                category: professionalDevCategoryId,
                subcategories: ['Management'],
                topics: [
                    'Change Leadership',
            ...
            },
            {
                ...
                description: 'Learn quality management systems, ISO standards, and quality assurance processes.',
                category: businessTrainingCategoryId,
                subcategories: ['Operations'],
                topics: [
                    'ISO Standards',
        ...
        for (const courseData of courses) {
            try {
                ...
                console.error(`❌ Failed to create: ${courseData.title}`, error.message || error);
