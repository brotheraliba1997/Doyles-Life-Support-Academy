...
exports.PassFailRecordSchema = exports.AssigmentPassFailRecordSchemaClass = exports.PassFailStatusEnum = void 0;
...
let AssigmentPassFailRecordSchemaClass = class AssigmentPassFailRecordSchemaClass extends document_entity_helper_1.EntityDocumentHelper {
};
exports.AssigmentPassFailRecordSchemaClass = AssigmentPassFailRecordSchemaClass;
__decorate([
    (0, mongoose_1.Prop)({
...
], AssigmentPassFailRecordSchemaClass.prototype, "studentId", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: mongoose_2.Types.ObjectId,
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], AssigmentPassFailRecordSchemaClass.prototype, "courseId", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: mongoose_2.Types.ObjectId,
        required: true,
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], AssigmentPassFailRecordSchemaClass.prototype, "sessionId", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: mongoose_2.Types.ObjectId,
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], AssigmentPassFailRecordSchemaClass.prototype, "classScheduleId", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: String,
...
], AssigmentPassFailRecordSchemaClass.prototype, "status", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: Number,
        required: true,
...
], AssigmentPassFailRecordSchemaClass.prototype, "totalClasses", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: Number,
        required: true,
    ...
    __metadata("design:type", Number)
], AssigmentPassFailRecordSchemaClass.prototype, "presentCount", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: Number,
        required: true,
    ...
    __metadata("design:type", Number)
], AssigmentPassFailRecordSchemaClass.prototype, "absentCount", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: Number,
        required: true,
    ...
    __metadata("design:type", Number)
], AssigmentPassFailRecordSchemaClass.prototype, "attendancePercentage", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: Boolean,
        default: false,
...
], AssigmentPassFailRecordSchemaClass.prototype, "isApproved", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: mongoose_2.Types.ObjectId,
        ref: user_schema_1.UserSchemaClass.name,
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], AssigmentPassFailRecordSchemaClass.prototype, "approvedBy", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: Date,
        required: false,
...
], AssigmentPassFailRecordSchemaClass.prototype, "approvedAt", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: Boolean,
        default: false,
    ...
    __metadata("design:type", Boolean)
], AssigmentPassFailRecordSchemaClass.prototype, "certificateIssued", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: mongoose_2.Types.ObjectId,
        required: false,
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], AssigmentPassFailRecordSchemaClass.prototype, "certificateId", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: String,
        required: false,
    ...
    __metadata("design:type", String)
], AssigmentPassFailRecordSchemaClass.prototype, "certificateUrl", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: String,
        trim: true,
    ...
    __metadata("design:type", String)
], AssigmentPassFailRecordSchemaClass.prototype, "notes", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: Date,
        default: () => new Date(),
    ...
    __metadata("design:type", Date)
], AssigmentPassFailRecordSchemaClass.prototype, "determinedAt", void 0);
exports.AssigmentPassFailRecordSchemaClass = AssigmentPassFailRecordSchemaClass = __decorate([
    (0, mongoose_1.Schema)({
        timestamps: true,
        toJSON: { virtuals: true, getters: true },
    })
], AssigmentPassFailRecordSchemaClass);
exports.PassFailRecordSchema = mongoose_1.SchemaFactory.createForClass(AssigmentPassFailRecordSchemaClass);
